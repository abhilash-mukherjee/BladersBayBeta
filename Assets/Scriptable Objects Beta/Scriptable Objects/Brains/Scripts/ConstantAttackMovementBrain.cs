...
[CreateAssetMenu(fileName = "New Constant Attack Movement Brain ", menuName = "AI Brains / Movement Brain / Constant Attacks")]
public class ConstantAttackMovementBrain : MovementBrain
{
    [SerializeField]
    ...
    public override Vector3 GetMoveDir(GameObject playerObject, GameObject enemyObject,Transform stadiumCentre, Vector3 previousDir)
    {
        ...
        { 
            return MoveTowardsEnemy(_enemyPos, _playerPos);
        }
    }
