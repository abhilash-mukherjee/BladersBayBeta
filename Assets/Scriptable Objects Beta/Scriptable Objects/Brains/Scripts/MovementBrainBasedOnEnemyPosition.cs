...
[CreateAssetMenu(fileName = "New Enemy Based Movement Brain ", menuName = "AI Brains / Movement Brain / Enemy Position Based")]
public class MovementBrainBasedOnEnemyPosition : MovementBrain
{
    [SerializeField]
    ...
    public override Vector3 GetMoveDir(GameObject playerObject, GameObject enemyObject,Transform stadiumCentre, Vector3 previousDir)
    {
        ...
        { 
            ...
            if (_dist <= thresholdDistance)
            {
                ...
                else return MoveTowardsEnemy(_enemyPos, _playerPos);
            }
            else
            {
                return previousDir;
